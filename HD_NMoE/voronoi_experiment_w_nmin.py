...
def voronoi_experiment_w_nmin(n_min, n_max, n_iter,
    ...
    for i in range (n_iter):
        ...
        # print(merge_ddg.argmin_dic())
        argmin_dic.append([n_samples, merge_ddg.argmin_dic()])
    ...
    name = "../data/voronoi_loss_K3_" + str(n_min) + "_" + str(n_max) + "_" + str(n_iter) + "_" + str(n_tries) + ".json"
